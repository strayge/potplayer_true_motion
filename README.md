...
`potplayer` directory has x64 versions of dlls.  
...
svpflow1_64.dll - https://www.svp-team.com/wiki/Download (Avisynth and Vapoursynth plugins, since version 4.3.0 shows red rectangles on video using version 4.2.0)
